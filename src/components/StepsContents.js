...
const steps = [
    ...
    <>
      <p>
        Але чому вірити Піфагорові на слово? Ліпше самостійно пересвідчитися,
        що його правило дійсно працює.
        Візьмімо для прикладу прямокутний трикутник зліва. Довжину кожної з його сторін можна
        оцінити за допомогою відповідної сітки (горизонтальної, вертикальної чи косої).
        Тоді можна взяти значення катетів, вирахувати за теоремою Піфагора довжину
        гіпотенузи і порівняти з тою, що бачимо на рисунку.
        Скористайся полем нижче, щоби знайти гіпотенузу на основі катетів.
      </p>
