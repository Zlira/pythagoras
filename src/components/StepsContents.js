...
const steps = [
    ...
    <>
      <p>
        Але чому вірити Піфагорові на слово? Ліпше самостійно пересвідчитися, що саме так і є.
        Ось візьмімо прямокутний трикутник зліва. Довжину кожної з його сторін можна
