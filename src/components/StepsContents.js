...
const steps = [
    ...
    <>
      <p>
        Перевірка теореми: є шкала, за якою можна оцінити довжини сторін. Бачимо приблизну
        довжину гіпотенузи, рахуємо цю саму довжину на основі катетів — порівнюємо значення.
      </p>
